...
- 검색엔진 소유확인: 네이버 `56cc76cf1afea2ae37639f2b93c6c66657f13b2a` · 구글 `i5hi9LYCn60BrNUsoNNjlnrmYXXJxdRWpS3yCmkfsaM` — 홈 `<head>` 에 생성기가 넣는다(`regions.js` 의 `verify`). **`index.html` 에 손으로 넣지 말 것** — 재생성하면 사라진다. 코드를 바꾸려면 `verify` 를 고치고 재생성.
